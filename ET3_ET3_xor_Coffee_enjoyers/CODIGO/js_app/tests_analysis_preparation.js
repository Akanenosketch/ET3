let def_tests_analysis_preparation = Array(
    ...
    //EDIT
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 47, "Cumple tamaño de fichero menor a 2000000 Bytes (2 MB)",                                "EDIT", 'analysis_preparation__nuevo_file_analysis_preparation__max_size_file_KO',    'El Nuevo Archivo supera el tamaño permitido, debe pesar menos de 2 MB.'),
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 48, "Cumple tipo correcto de fichero (.pdf, .doc, .docx)",                                  "EDIT", 'analysis_preparation__nuevo_file_analysis_preparation__type_file_KO',        'El Nuevo Archivo no es del tipo correcto, debe ser .pdf,.doc o .docx'),
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 49, "Cumple tener solo caracteres alfabeticos y puntos sin acentos,ñ o espacios de nombre", "EDIT", 'analysis_preparation__nuevo_file_analysis_preparation__format_name_file_KO', 'El nombre del Nuevo Archivo no cumple el formato correcto, debe contener solo letras y puntos sin acentos ni ñ ni espacios ni signos de puntuacion.'),
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 50, "Cumple tamaño de nombre minimo 7",                                                     "EDIT", 'analysis_preparation__nuevo_file_analysis_preparation__min_size_KO',         'El nombre del Nuevo Archivo es demasiado corto, debe tener al menos longitud 7.'),
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 51, "Cumple tamaño de nombre maximo 100",                                                   "EDIT", 'analysis_preparation__nuevo_file_analysis_preparation__max_size_KO',         'El nombre del Nuevo Archivo supera el tamaño permitido, debe tener como mucho longitud 100.'),
...
let pruebas_file_analysis_preparation = Array(
    ...
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 53, 217, "EDIT", "OK", Array("a".repeat(14),Array("application/pdf"),1999999),                                                      true),
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 53, 218, "EDIT", "OK", Array("a".repeat(13),Array("application/pdf"),1234),                                                         true),
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 53, 219, "EDIT", "OK", Array("a".repeat(13),Array("application/msword"),1234),                                                      true),
    Array("analysis_preparation", "nuevo_file_analysis_preparation", 53, 220, "EDIT", "OK", Array("a".repeat(13),Array("application/vnd.openxmlformats-officedocument.wordprocessingml.document"),1234), true),
