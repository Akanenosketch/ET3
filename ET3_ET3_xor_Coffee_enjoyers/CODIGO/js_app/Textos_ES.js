let textos_ES = {
    ...
    'func23' : 'cerrar_test()',
    'desc23' : '<b>Parámetros/Output: </b>No usa parámetros y su ejecución no produce ningun tipo de output.\n<b>Función:</b> Se encarga de limpiar la tabla de tests y ocultarlo.',
    ...
    'func27' : 'DELETE()',
    'desc27' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encargad de llamar al back y borrar una tupla existente dentro de la tabla de la entidad en la que estemos trabajando.',
    'func28' : 'cambiardatosespecialestabla(atributo, valoratributo)',
    ...
    'desc30' : '<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de ocultar las columnas que no están marcadas para mostrar.',
    ...
    // Posiblemente mover a otras funciones pq abarca varias funcionalidades
    'func55' : 'inicializar()',
    'desc55' : '<b>Parámetros/Output:</b> No usa parámetros y la ejecución de esta función no produce ningún tipo de output.\n<b>Función:</b> Se encarga de incializar todo lo necesarios para la creación de formularios, tablas y test.',
    // prosigamos....
    ...
    'func69' : 'mostrarform()',
    'desc69' : '<b>Parámetros/Output:</b>No se usan parámetros y la ejecución de esta función no proporciona ninún tipo de output.\n<b>Función:</b> Muestra el formulario una vez creado, esta función es llamada por <b>createForm()</b>.',
    ...
    'desc72' : '<b>Parámetros/Output:</b> No se usan parámetros y la ejecución de esta función no proporcionan ningún output.\n<b>Función:</b> Se encarga de cerrar el modal una vez que el usuario lo ha visto.',
    'func73' : 'cerrar_formulario()',
    'desc73' : '<b>Parámetros/Output:</b> No se usan parámetros y la ejecución de esta función no proporcionan ningún output.\n<b>Función:</b> Se encarga de cerrar el formulario una ver envíado al back o cuando el usuario lo cancela.',
    ...
    'func77' : 'menu_work()',
    'desc77' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de abrir y cerrar el menú, es llamada por la función <b>evento(event)</b> cuando hay que cerrar el menú.',
    'func78' : 'toggleTheme()',
    'desc78' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de manejar los cambios de modo claro a modo oscuro.',
    ...
    'desc91' : '<b>Parámetros:</b>\n\tid:\n\t\tTipo: String.\n\t\tDescripción: Hace referencia a un elemento HTML.\n\t\texpreg:\n\t\tTipo: String.\n\t\tDescripción: Expresión regular empleada para comprobar el formato del valor del elemento contenido en id.\n<b>Output:</b>Devuleve un valor booleando correspondiente al output de <b>evaluar_regex(valor, expreg)</b>, indicando si el valor introducido en el campo id cumpel con el formato indicado o no.\n<b>Función:</b> Se encarga de comprobar si el nombre del fichero adjuntado cumple con el formato establecido o no.',
