let textos_ES = {
    ...
    'func1' : 'test_run()',
    'desc1' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no produce ningún tipo de output.\n<b>Función:</b> Se encarga de preparar, verificar y ejecutar todos los test que han sido definidos.',
    'func2' : 'prepararTest()',
    'desc2' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no produce ningún tipo de output.\n<b>Función:</b> Es llamada por <b>test_run()</b> para limpiar las tablas y crear los arrays necesarios para ejecutar los tests.',
    'func3' : 'crearArrays()',
    'desc3' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no produce ningún tipo de output.\n<b>Función:</b> Se encarga de crear los arrays para las definiciones de test, las pruebas y las pruebas específicas de archivos y especiales, es llamada por <b>test_run()</b>.',
    'func4' : 'verificar()',
    'desc4' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no produce ningún tipo de output.\n<b>Función:</b> Se encarga de comprobar que todas las definiciones de test y de pruebas están definidas correctamente, esta función es llamada por <b>test_run()</b>',
    'func5' : 'verificarDeftest()',
    'desc5' : '<b>Parámetros/Output:</b> No usa parámetros y su ejecución no produce ningún tipo de output.\n<b>Función:</b> Se encarga de de verificar que el formato de las definiciones de test son correctas, esta función es llamada por <b>verificar()</b>',
    ...
    'func23':'SEARCH(empieza, filas)',
    'desc23':'<b>Parámetros:</b>\n\tempieza:\n\t\tTipo: Número\n\t\tDescripción: Indica el número por donde empieza la paginación.\n\tfilas:\n\t\tTipo: número\n\t\tDescipción: Indica el número de tuples que habrá por página.<b>Output: </b>La ejecución de esta función no proporciona ningún tipo de output.<b>Función:</b> Se encarga de buscar tuplas dentro de una entidad en base a unos criterios especificados para, posteriormente, mostrarlos en la tabla.',
    'func24':'ADD()',
    'desc24':'<b>parámetros/Output:</b> No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encargad de llamar al back e insertar una nueva tupla dentro de la tabla de la entidad en la que estemos trabajando.',
    'func25':'EDIT()',
    'desc25':'<b>Parámetros/Output:</b> No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encargad de llamar al back y editar la tupla editada dentro de la tabla de la entidad en la que estemos trabajando.',
    'func26':'DELETE()',
    'desc26':'<b>Parámetros/Output:</b> No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encargad de llamar al back y borrar una tupla existente dentro de la tabla de la entidad en la que estemos trabajando.',
    'func27':'cambiardatosespecialestabla(atributo, valoratributo)',
    'desc27':'<b>Parámetros:</b>\n\atributo:\n\t\tTipo: String\n\t\tDescripción: Hace referencia a un elemento perteneciente a una entidad.\n\tvaloratributo:\n\t\tTipo: String\n\t\tDescipción: Valor que tiene el atributo atributp almacenado.<b>Output: </b>Proporciona un output en tipo string que hace referencia a un elemento html que cambia como se ven los datos especiales dentro de la tabla.<b>Función:</b> Se encarga de cambiar los datos/atributos asignados como datos especiales para que se puedan ver con el formato permitido en la tabla.',
    'func28':'modificarcolumnasmostrar(atributo)',
    'desc28':'<b>Parámetros:</b>\n\tatributo:\n\t\tTipo: String\n\t\tDescripción: Hace referencia a un elemento de un entidad.<b>Output: </b>La ejecución de esta función no proporciona ningún tipo de output.<b>Función: </b> Se emplea para mostrar o ocultar la columna asociada al atributo seleccionado en el select.',
    'func29':'mostrarocultarcolumnas()',
    'desc29':'<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de ocultar las columnas que no están marcadas para mostrar.',
    'func30':'cambiarcolumnatabla(atributo)',
    'desc30':'<b>Parámetros:</b>\n\tatributo:\n\t\tTipo: String\n\t\tDescripción: Hace referencia a un elemento de un entidad.<b>Output: </b>La ejecución de esta función no proporciona ningún tipo de output.<b>Función: </b> Se encarga de ocultar la tabla en base al atributo pasado en los parámetros, esta función es llamada por <b>mostrarocultarcolumna()</b>.',
    'func31':'crearTablaDatos()',
    'desc31':'<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de llamar a las funciones auxiliares necesarias para crear las tablas.',
    'func32':'construirSelect()',
    'desc32':'<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de crear el select de selección de columnas.',
    'func33':'hacerTabla()',
    'desc33':'<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de crear la propia tabla, esta función es llamada por <b>crearDatosTabla()</b>.',
    'func34':'hacerPaginacion()',
    'desc34':'<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de llamar a la función encargada de crear la paginación en el caso de que existan tuplas, en caso contrario se ocultan todos los elementos del HTML relacionados con la paginación..',
    'func35':'levantarPaginacion()',
    'desc35':'<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se encarga de propiamente crear la paginación, esta función es llamada por <b>hacerPaginacion()</b>.',
    'func36':'crearboton(accion, parametro)',
    'desc36':'<b>Parámetros:</b>\n\accion:\n\t\tTipo: String\n\t\tDescripción: Hace referencia las acciones que se pueden realizar: DELETE, SHOWCURRENT, EDIT.\n\tparámetros:\n\t\tTipo: String\n\t\tDescipción: Ni puta idea p2.<b>Output:</b> Devulve un HTMLTableCellElement con el svg de los iconos.<b>Función:</b> Se encarga de crear los botones y los iconos correspondientes para las acciones de DELETE, SHOWCURRENT y EDIT.',
    'func37':'cerrar_tabla()',
    'desc37':'<b>Parámetros/Output:</b>No usa parámetros y su ejecución no proporciona ningún tipo de output.\n<b>Función:</b> Se oculta la tabla y se oculta el boton de test.',
    'func39':'',
    'desc39':'',
    'func40':'',
    'desc40':'',
    ...
    'func41':'crearForm()',
    'desc41':'<b>Parámetros/Output:</b> No usa parámetros y su ejecución no produce ningún tipo de output.\n<b>Función:</b> Se encarga de llamar a la función auxiliar <b>crearFormAtributo()</b> para crear el formulario.',
    'func42':'crearFormAtributo(atributo)',
    'desc42':'<b>Parámetros:</b>\n\tatributo:\n\t\tTipo: String\n\t\tDescripción: Hace referencia a un elemento perteneciente a una entidad.\n<b>Output:</b> La ejecución de esta función no proporciona ningún output\n<b>Función:</b> Se encarga de crear la parte del formulario asociada a un atributo, esta función es llamada por <b>crearForm()</b>.',
    'func43':'crearInput(datos, atributo)',
    'desc43':'<b>Parámetros:</b>\n\tdatos:\n\t\tTipo: Array\n\t\tDescripción: Es un ya lista con los diferentes tipos de input que s epueden usar dentro de un formulario.\n\tatributo\n\t\tTipo: String\n\t\tDescripción: Hace referencia a un elemento perteneciente a una entidad.\n<b>Output:</b> La ejecución de esta función no genera ningún tipo de Output.\n<b>Función:</b> Se encarga de crear el input para un determinado atributo, esta función es llamada por <b>crearFormAtributo()</b>.',
    'func44':'crearTextarea(datos, atributo)',
    ...
    'func45':'crearSelect(datos, atributo)',
    ...
    'func47':'crearSpanError(atributo)',
    ...
    'func50':'ponernoactivoform(accion)',
    ...
    'func53':'SearchPH()',
    'desc53':'<b>Parámetros/Output:</b> No usa parámetros y su ejecución no produce ningún tipo de output.\n<b>Función:</b> Se encarga de buscar y de colocar los placeholders para los formularios de SEARCH.',
    'func54':'colocarValoresForm(parametros)',
    'desc54':'',
    'func55':'colocarValor(atributo, valor)',
    'desc55':'',
    'func56':'mostrarvaloresespecialesform(atributo, valoratributo)',
    'desc56':'',
    'func57':'inicializar()',
    'desc57':'',
    'func58':'createForm(accion, parametros)',
    'desc58':'',
    'func59':'cargar_formulario(accion)',
    'desc59':'',
    'func60':'cargar_formulario_dinamico(accion)',
    'desc60':'',
    'func61':'ponerTitulosForm(accion)',
    'desc61':'',
    'func62':'eliminarCamposForm(accion)',
    'desc62':'',
    'func63':'mostrarAtributosForm(accion, parametros)',
    'desc63':'',
    'func64':'colocarvalidaciones(accion)',
    'desc64':'',
    'func65':'comprobar(id, accion)',
    'desc65':'',
    'func66':'ponernoactivo(accion)',
    'desc66':'',
    'func67':'colocarboton(accion)',
    'desc67':'',
    'func68':'colocarOnSubmitForm(accion)',
    'desc68':'',
    'func69':'comprobar_submit(accion)',
    'desc69':'',
    'func70':'colocarActionForm(accion)',
    'desc70':'',
    'func71':'mostrarform()',
    'desc71':'',
    'func72':'actuarRespuesta(respuesta)',
    'desc72':'<b>Parámetros:</b>\n\trespuesta:\n\t\tTipo: Ni puta idea\n<b>Output:</b> La ejecución de esta función no produce ningún tipo de output.\n<b>Función: </b>Se encarga de limpiar el formulario .',
